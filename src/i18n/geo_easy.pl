...
#	labels
#
set geoEasyMsg(pattern)		"Pattern:"
#
...
set geoEasyMsg(menuFile)		"File"
set geoEasyMsg(menuFileNew)		"New ..."
set geoEasyMsg(menuFileLoad)	"Load ..."
set geoEasyMsg(menuFileLogLoad) "Load log file"
set geoEasyMsg(menuFileLogClear) "Clear log file"
set geoEasyMsg(menuFileTclLoad) "Load tcl file"
set geoEasyMsg(menuFileUnload)	"Close"
set geoEasyMsg(menuFileSave)	"Save"
set geoEasyMsg(menuFileSaveAll)	"Save all"
set geoEasyMsg(menuFileSaveAs)	"Save as ..."
set geoEasyMsg(menuFileJoin)	"Merge ..."
set geoEasyMsg(menuFileExport)	"GNU Gama export ..."
set geoEasyMsg(menuProjLoad)	"Load project ..."
set geoEasyMsg(menuProjSave)	"Save project ..."
set geoEasyMsg(menuProjClose)	"Close project"
set geoEasyMsg(menuComEasy)		"ComEasy ..."
set geoEasyMsg(menuFileStat)	"Statistics ..."
set geoEasyMsg(menuFileCParam)	"Calculation parameters ..."
set geoEasyMsg(menuFileGamaParam) "Adjustment parameters ..."
set geoEasyMsg(menuFileColor)	"Colors ..."
set geoEasyMsg(menuFileOParam)	"Other parameters ..."
set geoEasyMsg(menuFileSaveP)	"Save parameters"
set geoEasyMsg(menuFileSaveSelection) "Save selection ..."
set geoEasyMsg(menuFileFontSetup) "Font ..."
set geoEasyMsg(menuFileFind)	"Find"
set geoEasyMsg(menuFileClear)	"Clear content"
set geoEasyMsg(menuFileExit)	"Exit"
set geoEasyMsg(menuEdit)		"Edit"
set geoEasyMsg(menuEditGeo)		"Observations"
set geoEasyMsg(menuEditCoo)		"Coordinates"
set geoEasyMsg(menuEditPar)		"Observation parameters"
set geoEasyMsg(menuEditMask)	"Load mask definitions"
set geoEasyMsg(menuHelpAbout)	"About GeoEasy ..."
set geoEasyMsg(menuPopupBD)		"Bearing/Distance"
set geoEasyMsg(menuPopupAngle)	"Setting out"
set geoEasyMsg(menuPopupOri)	"Orientation"
set geoEasyMsg(menuPopupAppOri)	"Appr. orientation"
set geoEasyMsg(menuCalDelOri)	"Delete orientations ..."
set geoEasyMsg(menuPopupPol)	"Polar point"
set geoEasyMsg(menuPopupSec)	"Intersection"
set geoEasyMsg(menuPopupRes)	"Resection"
set geoEasyMsg(menuPopupArc)	"Arcsection"
set geoEasyMsg(menuPopupEle)	"Elevation"
set geoEasyMsg(menuPopupDetail)	"Detail points"
set geoEasyMsg(menuPopupAdj3D)	"3D adjustment"
set geoEasyMsg(menuPopupAdj2D)	"Horizontal adjustment"
set geoEasyMsg(menuPopupAdj1D)	"Elevation adjustment"
set geoEasyMsg(menuGraph)		"Window"
set geoEasyMsg(menuGraNew)		"New graphic window"
set geoEasyMsg(menuLogNew)		"Log window"
set geoEasyMsg(menuConsoleNew)	"Console window"
set geoEasyMsg(menuWin)			"Window list"
set geoEasyMsg(menuRefreshAll)	"Refresh all window"
set geoEasyMsg(menuResize)		"Number of rows ..."
set geoEasyMsg(menuMask)		"Mask ..."
set geoEasyMsg(menuGraCom)		"Commands"
set geoEasyMsg(menuGraRefresh)	"Refresh"
set geoEasyMsg(menuGraFind)		"Find point ..."
set geoEasyMsg(menuGraPn)		"Point names"
set geoEasyMsg(menuGraObs)		"Observations"
