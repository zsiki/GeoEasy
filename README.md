...
See the [doc](./doc) folder for various reStructuredText files, the [wiki](./wiki) and the a paper in [Geinformatics FCE CTU](https://ojs.cvut.cz/ojs/index.php/gi/article/view/gi.17.2.1/4642).
